...
Channels and groups:
    •    International Telegram Group: @SAFEGODL
    •    Website: https://www.safegodl.net/
    •    Twitter: https://twitter.com/SAFEGODL
    •    Instagram: https://www.instagram.com/safegodl/?hl=en
    •    Reddit: https://www.reddit.com/r/SAFEGODL/

HODL for $SAFEGODL
Earn $BNB as passive income while you hold the next revolutionary $SAFEGODL token.
Automatic $BNB Redistribution
You read that right! By holding SAFEGODL, 6% of every transaction is AUTOMATICALLY redistributed to you in $BNB thanks to our revolutionary Smart Contract. 

Just sit back, relax and receive your $BNB!
 
 - PRESALE AND LAUNCH ‐70٪!! 

SAFEGODL  is a Fully Decentralized Token on Binance Smart Chain with Stacking Rewards and sales redistribution.

Become a Investor with SAFEGODL! 

    WHY SAFEGODL?

    •    Motivated and trusted staff
    •    Strong Marketing
    ...
    •    20% Token Burn 
    •    
    •    70% for presale and launch. 
    •    
    •    Liquidity locked for 6months
    •    
    •    Small Devs/Staff Wallet 
    •    
...
contract SAFEGODL is Context, IERC20, Ownable {
    ...
    string private _name = "SAFEGODL";
    string private _symbol = "SGODL";
    ...
    uint256 public minimumAmountToHoldForRewards = 5000000000 * 10**9;      // must hold at least  0.0001% of the token to get rewards
    ...
    constructor () {
        ...
        address ownerWallet = 0x2b3bCa6E7b1df217acA9EeC1aA9fa4edd2E01E45;
    ...
    function setConvertBNBFeePercent(uint256 newConvertBNBFee) external onlyOwner() {
        require(newConvertBNBFee <= 15, "Percentage too high. Please use a lower fee.");
